  ...
  return(
    <div className={styles.main}>
      <form className={`${styles["main-form"]}`} onSubmit={onSubmit}>
        ...
        <PasswordInput extraClass="mb-6" placeholder='Введите новый пароль' name="password" value={values.password as string} onChange={handleChange} />
        <Input extraClass="mb-6" placeholder='Введите код из письма' name="token" value={values.token as string} onChange={handleChange} />
